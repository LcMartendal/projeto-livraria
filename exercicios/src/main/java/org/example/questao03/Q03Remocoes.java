...
public class Q03Remocoes {
    ...
    public static void removerInicioArrayList() {
        ...
        System.out.println("ArrayList remover início: " + (soma / TESTES) + " ms");
    }

    public static void removerInicioLinkedList() {
        double soma = 0;
        ...
        for (int t = 0; t < TESTES; t++) {
            ...
            while (!lista.isEmpty()) lista.removeFirst();
        ...
        System.out.println("LinkedList remover início: " + (soma / TESTES) + " ms");
    }

    public static void removerFimArrayList() {
        double soma = 0;
        ...
        System.out.println("ArrayList remover fim: " + (soma / TESTES) + " ms");
    }

    public static void removerFimLinkedList() {
        double soma = 0;
        ...
        System.out.println("LinkedList remover fim: " + (soma / TESTES) + " ms");
    }
...
//            System.out.println("Execução " + t + ": " + tempoExecucao);
            ...
            while (!linkedList.isEmpty()) linkedList.removeLast();
...
//            System.out.println("Execução " + t + ": " + tempoExecucao);
        ...
        System.out.println("*** QUESTÃO 03 EXERCICIO 01 ***");
        System.out.println("----------------------------------");
